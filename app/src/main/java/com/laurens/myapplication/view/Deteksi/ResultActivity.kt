package com.laurens.myapplication.view.Deteksi
...
import com.laurens.myapplication.databinding.ActivityResultBinding
import com.laurens.myapplication.utils.GPSTracker
...
class ResultActivity : AppCompatActivity() {
    ...
    private fun BananaDescriptions() {
        val inputStream = resources.openRawResource(R.raw.skin)
